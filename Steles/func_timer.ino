...
void updateTimer() {
	...
	if (
		(RECORDMODE && (!(POS[RECORDSEQ] % 16))) // If at the start of a new beat of RECORDSEQ...
		|| ((!RECORDMODE) && (!(CUR16 % 4))) // Or we're on the first tick within a global quarter-note in PLAY MODE...
	) {
