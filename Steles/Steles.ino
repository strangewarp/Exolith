...
byte ARPLAST = 0; // Tracks the most-recent key to be arpeggiated by REPEAT
byte ARPDIR = 1; // Direction in which REPEAT-arpeggiation is currently flowing (1 for up, 0 for down)
byte ARPBUTTON = 0; // Last note-button pressed; this is used to dictate ARPDIR based on the current keypress
