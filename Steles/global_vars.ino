...
byte SEQ_POS[17]; // Holds 32 seqs' 4-bit slice-positions: (bit 0 = playing, bits 1-3 = 1, 2, 4) (global tick corresponds to sub-slice position)
...
byte SEQ_SIZE[17]; // Holds 32 4-bit values for each seq's size: (1 to 15; 0 = 16) * 4 = beats in seq
